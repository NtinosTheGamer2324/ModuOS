...
const uint8_t *bitmap_font_glyph8x16(uint8_t ch) {
    ...
    switch (ch) {
        ...
        /* Box drawing (fallback to ASCII approximations if you don't have full CP437 art):
         * 0xC4 '─'  -> '-'
         * 0xB3 '│'  -> '|'
         * corners/tees/cross -> '+'
         */
        case 0xC4: return font8x16_basic['-' - 0x20]; /* ─ */
        case 0xB3: return font8x16_basic['|' - 0x20]; /* │ */
        case 0xDA: /* ┌ */
        case 0xBF: /* ┐ */
        case 0xC0: /* └ */
        case 0xD9: /* ┘ */
